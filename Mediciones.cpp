...
size_t calcularMemoria(const std::vector<std::string>& dataset){
    ...
    total += dataset.capacity() * sizeof(std::string); 
...
void ejecutarQuicksort(std::vector<std::string> dataset){
    ...
    std::cout << "Tiempo de ejecucion de Quicksort: " << duracion.count() << " segundos" << std::endl;

    std::cout << "Memoria usada por Quicksort: " << memoria << " bytes" << std::endl;
}
...
void ejecutarHeapsort(std::vector<std::string> dataset){
    ...
    std::cout << "Tiempo de ejecucion de Heapsort: " << duracion.count() << " segundos" << std::endl;

    std::cout << "Memoria usada por Heapsort: " << memoria << " bytes" << std::endl;
}
...
void ejecutarAVL(std::vector<std::string> dataset) {
    ...
    std::cout << "Tiempo de ejecucion de AVL: " << duracion.count() << " segundos" << std::endl;

    std::cout << "Memoria usada por AVL: " << memoria << " bytes" << std::endl;
}
